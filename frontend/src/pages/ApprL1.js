// 📄 ApprL1.js - Shows rejected shifts for Lv1 Approver
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.pageContainer}>
          <div style={styles.formContainer}>
            <h2 style={styles.heading}>Rejected Shifts - Level 1</h2>
            <input
              type="text"
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {filteredShifts.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="12" style={styles.td}>No rejected shifts found.</td>
                  </tr>
                )}
              </tbody>
            </table>
...
const styles = {
  ...
  pageContainer: { display: "flex", alignItems: "flex-start", padding: "30px" },
  formContainer: {
    width: "95%",
    maxWidth: "1130px",
    padding: "15px",
